...
%TODO \CHANGED{Recently, Zung \etal~\cite{error_detection_framework} report the successful application of 3D multiscale convolutional neural networks for error detection and correction. 
