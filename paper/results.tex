...
\caption{Precision-recall curves comparing focused proofreading and our guided proofreading classifiers. We evaluate on unbalanced tests sets of the AC4 subvolume (darker colors) and the L. Cylinder volume (lighter colors). GP performs better.}
\label{fig:pr}
\end{figure}
