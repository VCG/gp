...
\caption{Receiver Operating Characteristic curves comparing automatic corrections of focused proofreading and guided proofreading. We evaluate on unbalanced tests sets of the AC4 subvolume (darker colors) and the L. Cylinder volume (lighter colors). Guided proofreading performs better.}
\label{fig:pr}
\end{figure}
