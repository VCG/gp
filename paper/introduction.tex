...
We learn a classifier for split errors with a convolutional neural network
...
regions are sorted by their score, and a candidate correction is generated for each
...
probability are automatically corrected first, given an appropriate
