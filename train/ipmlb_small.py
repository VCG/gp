...
with open(os.path.expanduser('/n/regal/pfister_lab/haehn/FINAL/IPMLB/IPMLB_FULL_SMALL.p'), 'wb') as f:
  pickle.dump(cnn, f, -1)
with open(os.path.expanduser('~/Projects/gp/nets/IPMLB_FULL_SMALL.p'), 'wb') as f:
  pickle.dump(cnn, f, -1)
