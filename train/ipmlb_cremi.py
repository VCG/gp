...
with open('/n/regal/pfister_lab/haehn/CREMITEST/IPMLB_FULL_CREMILARGE.p', 'wb') as f:
  pickle.dump(cnn, f, -1)
with open(os.path.expanduser('~/Projects/gp/nets/IPMLB_FULL_CREMILARGE.p'), 'wb') as f:
  pickle.dump(cnn, f, -1)
