...
train4 = basedir + 'train4b.npz'
train4_targets = basedir + 'train4b_targets.npz'
...
p_target[0:train1_count] = train1_targets
...
p_target[train3_count:train3_count+train4_count] = train4_targets
