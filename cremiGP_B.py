...
# find merge errors, if we did not generate them before
merge_error_file = '/n/regal/pfister_lab/haehn/CREMIBIG/merge_errors_30.p'
...
bigM_cremi_file = '/n/regal/pfister_lab/haehn/CREMIBIG/bigM_gp.p'
