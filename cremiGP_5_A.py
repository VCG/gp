...
# OUTDIR = REGALDIR + 'CREMIBIGSPLITONLY_A/'
OUTDIR = REGALDIR + 'CREMI5_A/'
...
merge_error_file = OUTDIR + 'merge_errors_5.p'
...
#
  ...
  bigM_cylinder_after_95, out_cylinder_volume_after_auto_95, cylinder_auto_fixes_95, cylinder_auto_vi_s_95, vi_s_per_step2 = gp.Legacy.splits_global_from_M_automatic(cnn, bigM, input_image, input_prob, corrected_rhoana_05, input_gold, sureness_threshold=.00)
...
#
  ...
  bigM_cylinder_after_95, out_cylinder_volume_after_auto_95, cylinder_auto_fixes_95, cylinder_auto_vi_s_95, vi_s_per_step2 = gp.Legacy.splits_global_from_M(cnn, bigM, input_image, input_prob, corrected_rhoana_05, input_gold, hours=-1)
